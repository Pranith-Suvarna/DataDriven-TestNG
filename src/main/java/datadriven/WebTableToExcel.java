...
public class WebTableToExcel {
  public static void main(String[] args) throws IOException {
    ...
    chromeDriver.get("https://en.wikipedia.org/wiki/List_of_countries_and_dependencies_by_population");
    ...
    WebElement table = chromeDriver.findElement(By.xpath("//table[@class='wikitable sortable plainrowheaders jquery-tablesorter']/tbody"));
    ...
    for (int r = 1; r <= rows; r++) {
      ...
      System.out.println(String.valueOf(country) + population + perOfWorld + date + source);
